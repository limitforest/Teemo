 ...
 * @version $Revision: 1.1 $ $Date: 2011/10/14 00:56:35 $
 * @since Apr 1, 2006
 *
 */
public class Jpg2Dcm {
	...
	public void convert(File jpgFile, File dcmFile,String patientName,String patientID, String studyuid, String seriesuid, int n) throws IOException {
        jpgHeaderLen = 0;
