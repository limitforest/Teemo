...
public class StatusBar extends JComponent {
	...
	public PercentLayout createHorizontalPercentLayout(int gap) {
		return new PercentLayout(PercentLayout.HORIZONTAL, gap);
	}
...
//   }
	...
	public static void htmlize(JComponent component, Font font) {
		String stylesheet = "body { margin-top: 0; margin-bottom: 0; margin-left: 0; margin-right: 0; font-family: " + font.getName() + "; font-size: " + font.getSize() + "pt; }" + "a, p, li { margin-top: 0; margin-bottom: 0; margin-left: 0; margin-right: 0; font-family: " + font.getName()
